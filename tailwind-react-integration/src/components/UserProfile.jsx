function UserProfile() {
    return ( 
        <div className="bg-gray-100 sm:p-4 sm:max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg md:p-8">
            <img src="https://via.placeholder.com/150" alt="User" 
            className="rounded-full sm:w-24 sm:h-24 md:w-36 md:h-36 mx-auto"/>
            <h1 className="sm:text-lg md:text-xl text-center text-blue-800 my-4">John Doe</h1>
